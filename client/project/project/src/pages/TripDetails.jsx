...
//         setLoading(false);
//       } catch (err) {
//         console.error('Error fetching trip details(frontend):', err);
...
//     { name: 'Budget', icon: CurrencyDollarIcon, component: Budget },
...
//                 {tab.component ? (
//                   tab.name === 'Budget' ? <Budget trip={selectedTrip} /> : <p>Coming soon...</p>
//                 ) : (<p>Coming soon...</p>)}
//               </motion.div>
//             </Tab.Panel>
//           ))}
