...
//     }catch(err){
//       console.log("Itinerary Tab error while getting activities: ",err.message);
//     }
...
//     try{
//       const res = await axios.post(`http:/localhost:8000/api/activities/${selectedTrip.tripId}`)
//     }catch(err){
//       console.log("Error while posting activities: ",err.message);
//     }
//   }
...
//         />
//         <button onClick={postActivities} className="btn-primary">
